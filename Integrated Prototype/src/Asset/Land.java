...
Statement s = null;
    ...
    public void tableUpdate(){
           try{
            ...
            land.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public void tableUpdate1(){
           try{
            ...
            land_history.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    { 
     ...
     public void saveHistory(){
           try{
            String sql="Select count(Property_Id) AS count from Property_History where Property_Id Like '%"+txt_landId.getText()+"%' ";
		...
		String sql1="Insert into Property_History(Valuation_No,Property_Id,Location,Perches,Valuation_Date,Property_Value) values(?,?,?,?,?,?)";
                ...
                ps.setString(2,txt_landId.getText());
     ...
     public void auto1(){
        ...
        try {
            String a = txt_landId.getText();
            String ino[]=a.split("P");
            no1=Integer.parseInt(ino[1]);
            
            String sql = "SELECT Property_Id as propertyid FROM Property";
            ...
            while(rs.next())
            {
                list.add(rs.getString("propertyid"));
            }
    
            for(int i=0;i<=list.size()-1;i++){
	              
                String b = list.get(i);
                String ino1[]=b.split("P");
		...
		if(no1+1<=no){
                    ...
                    String sql1="Update Property set Property_Id='"+id+"' where Property_Id='"+b+"'";
                    ps=conn.prepareStatement(sql1);
                    ps.execute();
                }
            }
    ...
    private void initComponents() {
        ...
        land_history = new javax.swing.JTable();
        jPanel3 = new javax.swing.JPanel();
        txt_hisLandId = new javax.swing.JTextField();
        ...
        txt_landId = new javax.swing.JTextField();
        ...
        land_history.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Valuation No", "Land Id", "Perches", "Valuation Date", "Land Value", "Location"
            }
        ));
        jScrollPane2.setViewportView(land_history);
        ...
        txt_hisLandId.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txt_hisLandId.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(55, 55, 55)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_hisLandId, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txt_hisLandId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        land.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        land.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Land Id", "Perches", "Purchased Value", "Current Value", "Location"
            }
        ));
        land.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                landMouseClicked(evt);
            }
        });
        land.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                landKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(land);

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Land Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 22), new java.awt.Color(0, 0, 102))); // NOI18N
        ...
        txt_landId.setEditable(false);
        txt_landId.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txt_landId.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_perches, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                            .addComponent(txt_landId, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                            .addComponent(txt_location, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                            .addComponent(txt_value, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txt_landId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_insertActionPerformed
        ...
        try{
            ...
            ps.setString(1,txt_landId.getText());
    ...
    if(d==0)
    {
        ...
        try{
            String val1 = txt_landId.getText();
    ...
    private void landMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_landMouseClicked
        DefaultTableModel model =  (DefaultTableModel) land.getModel();
        int selectedRowIndex = land.getSelectedRow();
        
        txt_landId.setText(model.getValueAt(selectedRowIndex, 0).toString());
    ...
    }//GEN-LAST:event_landMouseClicked

    private void landKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_landKeyPressed
        DefaultTableModel model =  (DefaultTableModel) land.getModel();
        int selectedRowIndex = land.getSelectedRow();
    ...
    private void btn_historySearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_historySearchActionPerformed
       ...
       String sql="Select * from Property_History where Property_Id Like '%"+txt_hisLandId.getText()+"%' AND Location Like '%"+txt_hisLocation.getText()+"%'";
    ...
    private void btn_hisRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hisRefreshActionPerformed
        ...
        txt_hisLandId.setText(" ");
        txt_hisLocation.setText(" ");
    ...
    private void btn_demoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_demoActionPerformed
                ...
                txt_perches.setText("9");
                txt_value.setText("1000000");
              
                txt_location.setText("Kandy");
    ...
    private javax.swing.JTable land;
    private javax.swing.JTable land_history;
    private javax.swing.JTextField txt_hisLandId;
    private javax.swing.JTextField txt_hisLocation;
    private javax.swing.JTextField txt_landId;
...
private boolean validation() {
    ...
    try {
            ...
            if(txt_landId.getText().isEmpty())
            {
                JOptionPane.showConfirmDialog(rootPane, "Enter a Land id", "Error", JOptionPane.ERROR_MESSAGE);
                bool =false;
            }
            ...
            {
                JOptionPane.showConfirmDialog(rootPane, "Enter the Land value ", "Error", JOptionPane.ERROR_MESSAGE);
                bool =false;
            }
